...
LABEL "org.opencontainers.image.source"="https://github.com/skyfriends/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/skyfriends/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/skyfriends/action-slack-notify
